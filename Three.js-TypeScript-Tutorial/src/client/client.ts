...
// CircleGeometry : 다트판모양 ( 입체아님 )
// CylinderGeometry : 원통모양
// ConeGeometry : 뿔 모양
// ExtrudeGeometry : 모서리가 둥근 박스모양
// ShapeGeometry : 삼각형 ( 입체아님 )
// LatheGeometry : 보석모양
// PlaneGeometry : 사각형 ( 입체아님 )
// RingGeometry : 도넛모양 ( 입체아님 )
// SphereGeometry : 동그란 모양
// TorusGeometry : 튜브모양
// TorusKnotGeometry : 기괴한모양
// TubeGeometry : 연결호스 모양
// DodecahedronGeometry : 정십이면체
// IcosahedronGeometry : 정이십면체
// OctahedronGeometry : 정팔면체
// OctahedronGeometry : 정사면체
